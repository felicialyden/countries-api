  ...
  return (
    <div className="detail-main">
      ...
      <div className="country-info-wrapper">
        <p><span className="bold-text">Native Name: </span> {country?.nativeName}</p>
        <p><span className="bold-text">Population: </span> {country?.population.toLocaleString()}</p>
      ...
      <div className="country-info-wrapper">
        <p><span className="bold-text">Top Level Domain: </span>{country?.topLevelDomain[0]}</p>
        <p><span className="bold-text">Currencies: </span>{country?.currencies[0].name}</p>
        <p><span className="bold-text">Languages: </span>{country?.languages[0].name}</p>
      </div>
      <div className="country-info-wrapper">
